...
export const ALL_TOOLS: ToolData[] = [
  ...
  },
  {
    ...
    useCase: "Best suited for mid-market companies (200--1,500 employees) running matrixed programs---such as email marketing software releases---where product, engineering, marketing, and compliance teams must coordinate interdependent deliverables, measure OKR alignment, and visualize cross-project bottlenecks without building custom dashboards. Less ideal for organizations that need native time tracking or ad-hoc pivot reporting.",
  ...
  userQuotes: [
    {
      ...
      company: "Enterprise email marketing (1,200 employees)",
  ...
  },
  {
    ...
    longDescription:
      "Zendesk Suite remains a dominant mid-market customer service platform, balancing breadth and usability better than most competitors. Its core strength lies in unified ticketing, knowledge base, and messaging across channels — especially strong for SMBs scaling support operations. The UI is intuitive for agents, and native integrations with Slack, Salesforce, and Shopify reduce setup friction. However, customization depth lags behind enterprise alternatives like ServiceNow; complex workflow automation often requires coding or third-party tools like Zapier. Reporting is functional but lacks the granularity and real-time dashboards power users expect. Setup can become time-consuming when extending beyond default configurations, and the pricing model scales steeply with agent count and add-ons. Best suited for growth-stage email marketing and e-commerce companies needing reliable, multi-channel support without heavy IT dependency. Not ideal for highly regulated industries requiring deep audit ...",
    pros: [
    ...
    useCase: "Best for: Scaling email marketing and e-commerce companies with 10–200 agents needing integrated, channel-agnostic support. Not ideal for: Highly regulated enterprises requiring HIPAA/GDPR-compliant audit logs or large IT departments needing full ITSM workflows.",
  ...
  userQuotes: [
    ...
    longDescription:
      "Mixpanel is a leading product analytics platform designed for email marketing companies to deeply understand user behavior through event-based tracking, enabling data-driven product decisions. Its core value proposition centers on measuring what users *do* not just pageviews with granular behavioral cohorts, funnel analysis, and retention modeling. Key strengths include its powerful event-based analytics engine tracking user actions across web mobile and backend, real-time behavioral segmentation, and AI-powered insights such as automated insight detection. It serves growth teams, product managers, and engineering leads at mid-market and email marketing firms. Compared to alternatives like Amplitude or Google Analytics 4, Mixpanel excels in intuitive funnel visualization and robust A/B test integration. Ratings sourced from G2",
    pros: [
  ...
  },
  {
    ...
    useCase: "Best for scaling email marketing and tech companies with 50+ seat sales teams needing CRM-aligned, multi-touch outreach automation and performance analytics; not ideal for solopreneurs, SMBs with <5 reps, or non-sales use cases like marketing-only campaigns.",
  ...
  },
  {
    ...
    useCase: "Best for mid-market to enterprise email marketing companies ($25M–$2B ARR) with dedicated RevOps, Sales Enablement, or Revenue Science teams seeking scalable, AI-driven conversation analysis to improve win rates, forecast accuracy, and rep coaching. Not ideal for SMBs without CRM maturity, non-sales teams lacking structured call workflows, or organizations requiring native support for French, Spanish, or Japanese as primary analysis languages.",
  ...
  },
  {
    ...
    useCase: "Best for email marketing sales development reps, marketing operations managers, and ABM strategists at companies with $10M–$2B ARR who rely on accurate, scalable prospecting data; not ideal for solopreneurs, non-tech SMBs with <50 employees, or teams needing lightweight, low-cost contact lookup tools.",
  ...
  userQuotes: [
    {
      ...
      company: "Email Marketing Review",
