        ...
        <section className="pt-28 pb-12 text-center px-6">
          <Reveal y={12} blur>
            <p className="text-[10px] font-mono tracking-[0.3em] text-[#708094] mb-5 uppercase">
              {ALL_TOOLS.length} email tools reviewed
            </p>
          </Reveal>

          <Reveal delay={0.1} y={16} blur>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#e6eefc] mb-4 tracking-tight leading-[1.05]">
              Find Your Perfect<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00bcd4] to-[#a78bfa]">Email Stack</span>
            </h1>
          </Reveal>

          <Reveal delay={0.3} y={12}>
            <p className="text-base text-[#9bb1d0] max-w-lg mx-auto leading-relaxed">
              Compare {ALL_TOOLS.length} email marketing tools across {cats.length} categories. Side-by-side reviews, pricing, and expert insights.
            </p>
          </Reveal>
