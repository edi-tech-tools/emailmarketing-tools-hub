...
export const metadata: Metadata = {
  title: "Privacy Policy — Email Marketing Tools Hub",
  description:
    "Learn how Email Marketing Tools Hub collects, uses, and protects your personal data. Our privacy policy outlines our commitment to your privacy and data security.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#BE8A83] leading-relaxed">
          <section>
            ...
            <p>
              Email Marketing Tools Hub ("we," "our," or "us") is committed to protecting your privacy.
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">2. Information We Collect</h2>
            <h3 className="text-lg font-semibold text-[#FEF2F0] mb-2">Personal Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-lg font-semibold text-[#FEF2F0] mb-2">Automatically Collected Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-lg font-semibold text-[#FEF2F0] mb-2">Cookies and Tracking Technologies</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">4. Information Sharing and Disclosure</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">5. Cookie Policy</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">6. Your Rights (GDPR & CCPA)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">7. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">8. Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">9. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">10. International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">11. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">12. Contact Us</h2>
            <p>
              If you have questions about this Privacy Policy or our data practices, please
              contact us:
            </p>
            <div className="mt-4 p-5 bg-[#2D0F0F] border border-[#5F1E1E] rounded-xl">
              <p className="mb-2"><strong className="text-[#FEF2F0]">Email:</strong> privacy@b2b-software.net</p>
