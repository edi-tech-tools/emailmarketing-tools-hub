...
export const metadata: Metadata = {
  title: "Terms of Service — Email Marketing Tools Hub",
  description:
    "Read the Terms of Service for Email Marketing Tools Hub. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
  ...
  return (
    <div className="relative pt-32 pb-20 px-6">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#BE8A83] leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">1. Acceptance of Terms</h2>
            <p>
              By accessing or using the Email Marketing Tools Hub website (the "Site"), you agree to be
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">3. User Accounts and Registration</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">4. User Conduct</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">5. Intellectual Property</h2>
            <p className="mb-3">
              ...
              content — are owned by Email Marketing Tools Hub and are protected by international
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">6. Tool Listings and Reviews</h2>
            <p className="mb-3">
            ...
            <p className="mb-3">
              ...
              of Email Marketing Tools Hub. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">7. Third-Party Links and Services</h2>
            <p>
              Our Site contains links to third-party websites and services that are not owned or
              controlled by Email Marketing Tools Hub. We have no control over, and assume no
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">8. Subscription and Pricing Information</h2>
            <p className="mb-3">
            ...
            <p>
              Email Marketing Tools Hub offers free access to our directory and comparison features.
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">9. Limitation of Liability</h2>
            <p>
              To the fullest extent permitted by law, Email Marketing Tools Hub, its officers, directors,
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">10. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">11. Indemnification</h2>
            <p>
              You agree to indemnify, defend, and hold harmless Email Marketing Tools Hub and its
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">12. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">13. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#FEF2F0] mb-3">14. Contact Information</h2>
            <div className="mt-4 p-5 bg-[#2D0F0F] border border-[#5F1E1E] rounded-xl">
              <p className="mb-2"><strong className="text-[#FEF2F0]">Email:</strong> legal@b2b-software.net</p>
              <p className="mb-2"><strong className="text-[#FEF2F0]">Support:</strong> support@b2b-software.net</p>
